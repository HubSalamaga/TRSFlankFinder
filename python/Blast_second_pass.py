...
def main():
    ...
    parser = argparse.ArgumentParser(description='''This program analyzes the blast output files to find unique sequences flanked by TRS''')
    ...
    filtered_fasta_file = FileHandler.find_file_by_name('unique_taxids_full_sequences_blastn_out.txt',folder= results_directory)
    ...
    final_results = os.path.join(results_directory,"final_results")
    FileHandler.ensure_directory_exists(final_results)
